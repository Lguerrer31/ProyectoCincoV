...
public class EjercicioCinco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 130, 80));

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "Botones", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 12))); // NOI18N
        ...
        jPanel3.add(cmdB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, -1, -1));
        ...
        jPanel3.add(cmdC, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, -1, -1));

        cmdLM.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        cmdLM.setText("Llenado manual");
        cmdLM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdLMActionPerformed(evt);
            }
        });
        jPanel3.add(cmdLM, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, -1, -1));
        ...
        jPanel3.add(cmdLA, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));
        ...
        jPanel3.add(cmdM, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, -1));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, 170, 230));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 27, 146, -1));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 160, 120));
    ...
    private void cmdCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCActionPerformed
        ...
        if (txtL.getText().trim().isEmpty()) {
            ...
            if (longitud % 2 == 0) {
                ...
                JOptionPane.showMessageDialog(this, "No se puede crear el vector por favor digite un número par", "Error", JOptionPane.ERROR_MESSAGE);
                txtL.requestFocusInWindow();
            }
        }
